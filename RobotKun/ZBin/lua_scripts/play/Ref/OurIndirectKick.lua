...
-- gCurrentPlay = "TestFreeKick_6vs6"

if math.sqrt(ball.refPosX() * ball.refPosX() + ball.refPosY() * ball.refPosY()) < 100 then
  	gCurrentPlay = "Ref_KickOffV601"
else
	gCurrentPlay = "TestFreeKick_6vs6_v2"
end
  --end
