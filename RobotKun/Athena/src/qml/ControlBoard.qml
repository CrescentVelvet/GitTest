...
Page{
    ...
    property bool autoIMUBlue : false;
    property bool autoIMUYellow : false;
...
//        }
    ...
    StackLayout {
        id:controlLayout;
        width: control.width;
        height:control.height; //fix display bug at low resolution.2019.3.29 wz
...
//                        }
                        ...
                        ZButton{
                            icon.source:"/source/imu.png"
                            icon.color: control.autoIMUBlue ? "#444" : "#69b6ff";
                            text:"<font color=" + (control.autoIMUBlue ? "'#444'>AUTO" : "'#69b6ff'>OFF") + "</font>"
                            display: AbstractButton.TextBesideIcon
                            Material.background: control.autoIMUBlue ? "#3986bf" : "#444" ;
                            onClicked: {
                                control.autoIMUBlue = ! control.autoIMUBlue;
                                if(control.autoIMUBlue){
                                    interaction.imuclean(0);
                                }
                                else interaction.imucleanend(0);
                            }
                        }
                        ZButton{
                            icon.source:"/source/imu.png"
                            icon.color: control.autoIMUYellow ? "#444" : "#fffb9c";
                            text:"<font color=" + (control.autoIMUYellow ? "'#444'>AUTO" : "'#ebdb7c'>OFF") + "</font>"
                            display: AbstractButton.TextBesideIcon
                            Material.background: control.autoIMUYellow ? "#9f9b4c" : "#444" ;
                            onClicked: {
                                control.autoIMUYellow = ! control.autoIMUYellow;
                                if(control.autoIMUYellow) {
                                    interaction.imuclean(1);
                                }
                                else interaction.imucleanend(1);
                            }
                        }
                        ZButton{
                    ...
                    Grid{
                        ...
                        ZButton {
                                ...
                                onClicked: {
                                    ...
                                    visionControls.ifConnected = false;
                                    interaction.setVision(false,simulation.checked);
                                }
                            }
                            Label {
                                id: labelsr
