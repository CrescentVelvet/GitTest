...
void ObstaclesNew::addObs(const CVisionModule * pVision, const TaskT & task, bool drawObs, double oppAvoidDist, double teammateAvoidDist, double ballAvoidDist, bool shrinkTheirPenalty, double penaltyBuffer) {
...
//    GDebugEngine::Instance()->gui_debug_msg(myPos, QString("%1").arg(flags & PlayerStatus::NOT_AVOID_PENALTY).toLatin1(), COLOR_BLUE);
    ...
    if(flags & PlayerStatus::FREE_KICK) {
        addRectangle(CGeoPoint(PARAM::Field::PITCH_LENGTH / 2, -PARAM::Field::PENALTY_AREA_WIDTH / 2 + robotRadius - PARAM::Vehicle::V2::PLAYER_SIZE - 20.0*10 - penaltyBuffer),
                    CGeoPoint(PARAM::Field::PITCH_LENGTH / 2 - PARAM::Field::PENALTY_AREA_DEPTH + robotRadius - PARAM::Vehicle::V2::PLAYER_SIZE - 20.0*10 - penaltyBuffer, PARAM::Field::PENALTY_AREA_WIDTH / 2 - robotRadius + PARAM::Vehicle::V2::PLAYER_SIZE + 20.0*10 + penaltyBuffer),
                    0);
    }
    else if(!(flags & PlayerStatus::NOT_AVOID_PENALTY)) {
        if(shrinkTheirPenalty) {
            addRectangle(CGeoPoint(PARAM::Field::PITCH_LENGTH / 2, -PARAM::Field::PENALTY_AREA_WIDTH / 2 + robotRadius - PARAM::Vehicle::V2::PLAYER_SIZE - penaltyBuffer),
                        CGeoPoint(PARAM::Field::PITCH_LENGTH / 2 - PARAM::Field::PENALTY_AREA_DEPTH + robotRadius - PARAM::Vehicle::V2::PLAYER_SIZE - penaltyBuffer, PARAM::Field::PENALTY_AREA_WIDTH / 2 - robotRadius + PARAM::Vehicle::V2::PLAYER_SIZE + penaltyBuffer),
                        0);
        } else {

            addRectangle(CGeoPoint(PARAM::Field::PITCH_LENGTH / 2, -PARAM::Field::PENALTY_AREA_WIDTH / 2 - PARAM::Vehicle::V2::PLAYER_SIZE - penaltyBuffer),
                        CGeoPoint(PARAM::Field::PITCH_LENGTH / 2 - PARAM::Field::PENALTY_AREA_DEPTH - PARAM::Vehicle::V2::PLAYER_SIZE - penaltyBuffer, PARAM::Field::PENALTY_AREA_WIDTH / 2 + PARAM::Vehicle::V2::PLAYER_SIZE + penaltyBuffer),
                        0);
        }
    }
