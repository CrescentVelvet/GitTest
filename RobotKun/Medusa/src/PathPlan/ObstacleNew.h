...
class ObstaclesNew {
  ...
  public:
    ...
    void addObs(const CVisionModule* pVision, const TaskT& task, bool drawObs, double oppAvoidDist, double teammateAvoidDist, double ballAvoidDist, bool shrinkTheirPenalty, double penaltyBuffer = 0);
    void clear() {
