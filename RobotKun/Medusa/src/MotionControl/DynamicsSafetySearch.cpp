...
#define ACCURATE_AOID 2500
    ...
    double MAX_BALL_AVOID_DIST = 8*10;
...
CDynamicSafetySearch::CDynamicSafetySearch() {
    ...
    ZSS::ZParamManager::instance()->loadParam(MAX_TEAMMATE_AVOID_DIST,"DSS/DSS_TeammateMaxAvoidDist",15*10);
    ZSS::ZParamManager::instance()->loadParam(MIN_OPP_AVOID_DIST,"DSS/DSS_OppMinAvoidDist",5*10);
    ZSS::ZParamManager::instance()->loadParam(MAX_OPP_AVOID_DIST,"DSS/DSS_OppMaxAvoidDist",20*10);
    ...
    ZSS::ZParamManager::instance()->loadParam(MIN_PREDICT_FRAME_NUM,"DSS/DSS_PredictFrameNum",10);
