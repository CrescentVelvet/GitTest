...
//    CPlayerSpeedV2(int number, double xspeed, double yspeed, double rspeed, unsigned char dribble, int flag = 0);
    CPlayerSpeedV2(int number, double xspeed, double yspeed, double rspeed, bool useDir, unsigned char dribble, int flag = 0);
