...
CPlayerTask* CTaskFactoryV2::SmartGotoPosition(const TaskT& task) {
    return MakeTask< CSmartGotoPositionV3 >(task);
}
...
CPlayerTask* CTaskFactoryV2::ZSupport(const TaskT& task){
    return MakeTask<CZSupport>(task);
}

CPlayerTask* CTaskFactoryV2::ZBreak(const TaskT &task){
    return MakeTask<CZBreak>(task);
}

CPlayerTask* CTaskFactoryV2::ZAttack(const TaskT& task){
...
namespace PlayerRole {
    ...
    CPlayerTask* makeItGetBallV4(const int num, const int kick_flag, const CGeoPoint& pos, const CGeoPoint& waitPos, const double power, const double precision)
	{
		static TaskT playerTask;
		playerTask.executor = num;
    ...
    CPlayerTask* makeItZGoalie(const int runner,const CGeoPoint& pos,const int power,const int kick_flag){
        static TaskT playerTask;
    ...
    CPlayerTask* makeItZMarkEnemy(const int num, const int oppNum, const int priority, const int flag)
	{
		static TaskT playerTask;
		playerTask.executor = num;
    ...
    CPlayerTask* makeItZPass(const int num,const CGeoPoint& target, const double power, const int kick_flag, const double precision) {
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.pos = target;
        playerTask.player.kickpower = power;
    ...
    CPlayerTask* makeItFetchBall(const int num,const CGeoPoint& target, const double power, const int flag) {
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.pos = target;
        playerTask.player.kickpower = power;
        playerTask.player.kick_flag = flag;
        return TaskFactoryV2::Instance()->FetchBall(playerTask);
    }

    CPlayerTask* makeItZSupport(const int num) {
        static TaskT playerTask;
        playerTask.executor = num;
        return TaskFactoryV2::Instance()->ZSupport(playerTask);
    }

    CPlayerTask* makeItZBreak(const int num,const CGeoPoint& target, const double power, const int kick_flag, const double precision) {
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.pos = target;
        playerTask.player.kickpower = power;
        playerTask.player.kick_flag = kick_flag;
        playerTask.player.kickprecision = precision;
        return TaskFactoryV2::Instance()->ZBreak(playerTask);
    }

    CPlayerTask* makeItZAttack(const int num, const CGeoPoint& target, const CGeoPoint& waitPos, const double power, const int kick_flag, const double precision) {
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.pos = target;
        playerTask.player.kickpower = waitPos.x();
    ...
    CPlayerTask* makeItZDrag(const int num,  const CGeoPoint& target, const CGeoPoint& waitPos) {
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.pos = target;
        playerTask.player.kickpower = waitPos.x();
    ...
    CPlayerTask* makeItZBack(const int num, const int guardNum, const int index, const double power, const int flag, const int defendNum){
        static TaskT playerTask;
        playerTask.executor = num;
        playerTask.player.flag = flag;
