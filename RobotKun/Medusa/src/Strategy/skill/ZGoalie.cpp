...
CZGoalie::CZGoalie():_state(NOTHING){
    ...
    ZSS::ZParamManager::instance()->loadParam(GOALIE_CAPABILITY.maxAccel        ,"CGotoPositionV2/MGoalieAcc"   ,600*10);
    ZSS::ZParamManager::instance()->loadParam(GOALIE_CAPABILITY.maxSpeed        ,"CGotoPositionV2/MGoalieSpeed" ,300*10);
    ...
    ZSS::ZParamManager::instance()->loadParam(GOALIE_CAPABILITY.maxDec          ,"CGotoPositionV2/MGoalieDec"   ,600*10);
...
//    GDebugEngine::Instance()->gui_debug_arc(ZSkillUtils::instance()->getTheirInterPoint(ZSkillUtils::instance()->getTheirBestPlayer()), 20 ,0, 360);
    ...
    const CGeoPoint dribble_back_pos(ball+ball2point.unit()*30*10);
