...
public:
    ...
    CPlayerTask* ZSupport(const TaskT& task);
    CPlayerTask* ZBreak(const TaskT& task);
    CPlayerTask* ZAttack(const TaskT& task);
...
namespace PlayerRole{
    ...
    extern CPlayerTask* makeItGetBallV4(const int num, const int flag, const CGeoPoint& pos, const CGeoPoint& waitPos, const double power, const double precision=-1);
    ...
    extern CPlayerTask* makeItZMarkEnemy(const int num, const int oppNum, const int priority=0, const int flag=0);
    ...
    extern CPlayerTask* makeItZPass(const int num,const CGeoPoint& target, const double power, const int flag, const double precision=-1);
    extern CPlayerTask* makeItFetchBall(const int num,const CGeoPoint& target, const double power, const int flag=0);
    extern CPlayerTask* makeItZSupport(const int num);
    extern CPlayerTask* makeItZBreak(const int num,const CGeoPoint& target, const double power, const int flag, const double precision=-1);
    ...
    extern CPlayerTask* makeItZBack(const int num, const int guardNum, const int index, const double power, const int flag, const int defendNum);
}
