...
function isChip()
    return vision:ball():ChipBallState()
end

function chipPredictPos()
    return vision:ball():BestChipPredictPos()
end

function ChipSecondPos()
    return vision:ball():SecondChipPos()
end

function chipFlyTime()
    return vision:ball():ChipFlyTime()
end