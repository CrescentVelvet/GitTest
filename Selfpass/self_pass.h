...
public:
    ...
    void cal_angelVelToMove(const CVisionModule* pVision, const int leader);
    bool is_angelpenaltyPoint(const CVisionModule *pVision, const int leader, double height);
    bool is_angelOriToEnemy(const CVisionModule *pVision, const int leader, double xita);
    bool is_angelOriToMove(const CVisionModule *pVision, const int leader, double xita);
    bool is_angelVelToMove(const CVisionModule* pVision, const int leader, double xita);
    ...
    double input_angelOriToEnemy(const CVisionModule* pVision, const int leader);
    double input_angelOriToMove(const CVisionModule* pVision, const int leader);
    double input_angelVelToMove(const CVisionModule* pVision, const int leader);
    void output_saveData(const CVisionModule *pVision, const int leader);
    void output_selfPass(const CVisionModule *pVision, const int leader);
...
private:
    ...
    double _velAngleToEnemy;
    double _velDiffToEnemy;
