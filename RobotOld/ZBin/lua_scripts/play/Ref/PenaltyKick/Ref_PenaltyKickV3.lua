...
["goto"] = {
	...
	Leader   = task.goSpeciPos(CGeoPoint:new_local(param.pitchLength/2 - param.penaltyDepth - 20,0),0, DSS_FLAG),
	Middle   = task.goSpeciPos(CGeoPoint:new_local(0,100),player.toBallDir,DSS_FLAG),
	Special  = task.goSpeciPos(CGeoPoint:new_local(0,-100),player.toBallDir,DSS_FLAG),
	Fronter  = task.goSpeciPos(CGeoPoint:new_local(420, 220),player.toBallDir,DSS_FLAG),
	Center   = task.goSpeciPos(CGeoPoint:new_local(420, -220),player.toBallDir,DSS_FLAG),
