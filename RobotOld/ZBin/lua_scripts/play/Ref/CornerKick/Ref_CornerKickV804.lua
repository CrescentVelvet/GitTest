...
local PRE_PASS_POS = ball.refAntiYPos(CGeoPoint:new_local(430, -100))
local PASS_POS = CGeoPoint:new_local(450, -140)



local FAKE_POS_S = CGeoPoint:new_local(380, 200)
local FAKE_POS_S2 = CGeoPoint:new_local(500,200)
...
["start"] = {
        ...
        Leader   = task.goCmuRush(PRE_PASS_POS,_,_, DSS_FLAG),
...
["get"] = {
        switch = function()
                if bufcnt(player.infraredOn("Leader"),3,200) then
                        return "zshoot"
