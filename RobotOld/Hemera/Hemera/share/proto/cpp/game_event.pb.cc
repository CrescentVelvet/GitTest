...
class SSL_Referee_Game_Event_OriginatorDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<SSL_Referee_Game_Event_Originator> {
} _SSL_Referee_Game_Event_Originator_default_instance_;
class SSL_Referee_Game_EventDefaultTypeInternal : public ::google::protobuf::internal::ExplicitlyConstructed<SSL_Referee_Game_Event> {
...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, -1, sizeof(SSL_Referee_Game_Event_Originator)},
  { 7, -1, sizeof(SSL_Referee_Game_Event)},
};
...
void protobuf_AssignDescriptors() {
  ...
  AssignDescriptors(
      "game_event.proto", schemas, file_default_instances, TableStruct::offsets, factory,
...
void TableStruct::Shutdown() {
  _SSL_Referee_Game_Event_Originator_default_instance_.Shutdown();
  delete file_level_metadata[0].reflection;
  _SSL_Referee_Game_Event_default_instance_.Shutdown();
...
void TableStruct::InitDefaultsImpl() {
  ...
  _SSL_Referee_Game_Event_Originator_default_instance_.DefaultConstruct();
  _SSL_Referee_Game_Event_default_instance_.DefaultConstruct();
  _SSL_Referee_Game_Event_default_instance_.get_mutable()->originator_ = const_cast< ::SSL_Referee_Game_Event_Originator*>(
...
// @@protoc_insertion_point(message_clear_start:SSL_Referee_Game_Event)
  ...
  if (GetArenaNoVirtual() == NULL && originator_ != NULL) {
    delete originator_;
  }
  originator_ = NULL;
  gameeventtype_ = 0;
...
#if LANG_CXX11
void SSL_Referee_Game_Event::set_message(::std::string&& value) {
