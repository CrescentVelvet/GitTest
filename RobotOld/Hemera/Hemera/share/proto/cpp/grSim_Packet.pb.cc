...
// @@protoc_insertion_point(message_clear_start:grSim_Packet)
  ...
  commands_ = NULL;
  if (GetArenaNoVirtual() == NULL && replacement_ != NULL) {
    delete replacement_;
  }
  replacement_ = NULL;
}
...
#define DO_(EXPRESSION) if (!GOOGLE_PREDICT_TRUE(EXPRESSION)) goto failure
  ...
  for (;;) {
    ...
    switch (::google::protobuf::internal::WireFormatLite::GetTagFieldNumber(tag)) {
      ...
      // .grSim_Replacement replacement = 2;
      case 2: {
        if (static_cast< ::google::protobuf::uint8>(tag) ==
...
bool grSim_Packet::has_replacement() const {
  return this != internal_default_instance() && replacement_ != NULL;
}
void grSim_Packet::clear_replacement() {
  if (GetArenaNoVirtual() == NULL && replacement_ != NULL) delete replacement_;
  replacement_ = NULL;
}
