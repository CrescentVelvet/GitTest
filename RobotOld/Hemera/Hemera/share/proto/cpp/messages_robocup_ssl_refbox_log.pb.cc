...
static const ::google::protobuf::internal::MigrationSchema schemas[] = {
  { 0, -1, sizeof(Log_Frame)},
  { 7, -1, sizeof(Refbox_Log)},
};
...
void AddDescriptorsImpl() {
  ...
  static const char descriptor[] = {
      ...
      "\tLog_Frame\022\"\n\005frame\030\001 \001(\0132\023.SSL_Detectio"
      "nFrame\022\022\n\nrefbox_cmd\030\002 \001(\t\"%\n\nRefbox_Log"
      "\022\027\n\003log\030\001 \003(\0132\n.Log_Frameb\006proto3"
  };
...
Log_Frame::Log_Frame()
  ...
  if (GOOGLE_PREDICT_TRUE(this != internal_default_instance())) {
    protobuf_messages_5frobocup_5fssl_5frefbox_5flog_2eproto::InitDefaults();
  }
  SharedCtor();
...
::google::protobuf::uint8* Refbox_Log::InternalSerializeWithCachedSizesToArray(
  ...
  for (unsigned int i = 0, n = this->log_size(); i < n; i++) {
    target = ::google::protobuf::internal::WireFormatLite::
      InternalWriteMessageNoVirtualToArray(
        1, this->log(i), deterministic, target);
  }
