...
// required float confidence = 17;
inline bool Vision_DetectionRobot::_internal_has_confidence() const {
...
inline float Vision_DetectionRobot::_internal_confidence() const {
  return confidence_;
}
...
inline void Vision_DetectionRobot::_internal_set_confidence(float value) {
  _has_bits_[0] |= 0x00010000u;
  confidence_ = value;
}
