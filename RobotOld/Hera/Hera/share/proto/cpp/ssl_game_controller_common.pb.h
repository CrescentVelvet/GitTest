...
class BotId : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:BotId) */ {
 public:
  ...
  inline BotId* New() const PROTOBUF_FINAL { return New(NULL); }

  BotId* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
...
class ControllerReply : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:ControllerReply) */ {
 public:
  ...
  inline ControllerReply* New() const PROTOBUF_FINAL { return New(NULL); }

  ControllerReply* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
...
class BallSpeedMeasurement : public ::google::protobuf::Message /* @@protoc_insertion_point(class_definition:BallSpeedMeasurement) */ {
 public:
  ...
  inline BallSpeedMeasurement* New() const PROTOBUF_FINAL { return New(NULL); }

  BallSpeedMeasurement* New(::google::protobuf::Arena* arena) const PROTOBUF_FINAL;
  void CopyFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
  void MergeFrom(const ::google::protobuf::Message& from) PROTOBUF_FINAL;
