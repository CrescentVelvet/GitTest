...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<3> scc_info_SSL_Referee_referee_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 3, 0, InitDefaultsscc_info_SSL_Referee_referee_2eproto}, {
...
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_referee_2eproto = {
  &descriptor_table_referee_2eproto_initialized, descriptor_table_protodef_referee_2eproto, "referee.proto", 1361,
  &descriptor_table_referee_2eproto_once, descriptor_table_referee_2eproto_sccs, descriptor_table_referee_2eproto_deps, 3, 1,
    ...
    switch (tag >> 3) {
      ...
      case 1:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 10)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_name(), ptr, ctx, "SSL_Referee.TeamInfo.name");
          CHK_(ptr);
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_Referee_TeamInfo::InternalSerializeWithCachedSizesToArray(
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_Referee_Point::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
    ...
    switch (tag >> 3) {
      ...
      case 10:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 80)) {
          ...
          blueteamonpositivehalf_ = ::PROTOBUF_NAMESPACE_ID::internal::ReadVarint(&ptr);
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_Referee::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
