...
extern PROTOBUF_INTERNAL_EXPORT_game_5fevent_2eproto ::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto;
...
static void InitDefaultsscc_info_SSL_Referee_Game_Event_game_5fevent_2eproto() {
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<1> scc_info_SSL_Referee_Game_Event_game_5fevent_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 1, 0, InitDefaultsscc_info_SSL_Referee_Game_Event_game_5fevent_2eproto}, {
      &scc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto.base,}};

static void InitDefaultsscc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto() {
  GOOGLE_PROTOBUF_VERIFY_VERSION;
...
::PROTOBUF_NAMESPACE_ID::internal::SCCInfo<0> scc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto =
    {{ATOMIC_VAR_INIT(::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase::kUninitialized), 0, 0, InitDefaultsscc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto}, {}};
...
const char descriptor_table_protodef_game_5fevent_2eproto[] PROTOBUF_SECTION_VARIABLE(protodesc_cold) =
  ...
  "OW\020\001\022\r\n\tTEAM_BLUE\020\002"
  ;
static const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable*const descriptor_table_game_5fevent_2eproto_deps[1] = {
};
static ::PROTOBUF_NAMESPACE_ID::internal::SCCInfoBase*const descriptor_table_game_5fevent_2eproto_sccs[2] = {
...
static bool descriptor_table_game_5fevent_2eproto_initialized = false;
const ::PROTOBUF_NAMESPACE_ID::internal::DescriptorTable descriptor_table_game_5fevent_2eproto = {
  &descriptor_table_game_5fevent_2eproto_initialized, descriptor_table_protodef_game_5fevent_2eproto, "game_event.proto", 819,
  &descriptor_table_game_5fevent_2eproto_once, descriptor_table_game_5fevent_2eproto_sccs, descriptor_table_game_5fevent_2eproto_deps, 2, 0,
  schemas, file_default_instances, TableStruct_game_5fevent_2eproto::offsets,
  file_level_metadata_game_5fevent_2eproto, 2, file_level_enum_descriptors_game_5fevent_2eproto, file_level_service_descriptors_game_5fevent_2eproto,
};

// Force running AddDescriptors() at dynamic initialization time.
static bool dynamic_init_dummy_game_5fevent_2eproto = (  ::PROTOBUF_NAMESPACE_ID::internal::AddDescriptors(&descriptor_table_game_5fevent_2eproto), true);
...
const SSL_Referee_Game_Event_Originator& SSL_Referee_Game_Event_Originator::default_instance() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&::scc_info_SSL_Referee_Game_Event_Originator_game_5fevent_2eproto.base);
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_Referee_Game_Event_Originator::InternalSerializeWithCachedSizesToArray(
...
void SSL_Referee_Game_Event::SharedCtor() {
  ::PROTOBUF_NAMESPACE_ID::internal::InitSCC(&scc_info_SSL_Referee_Game_Event_game_5fevent_2eproto.base);
  message_.UnsafeSetDefault(&::PROTOBUF_NAMESPACE_ID::internal::GetEmptyStringAlreadyInited());
    ...
    switch (tag >> 3) {
      ...
      case 3:
        if (PROTOBUF_PREDICT_TRUE(static_cast<::PROTOBUF_NAMESPACE_ID::uint8>(tag) == 26)) {
          ptr = ::PROTOBUF_NAMESPACE_ID::internal::InlineGreedyStringParserUTF8Verify(_internal_mutable_message(), ptr, ctx, "SSL_Referee_Game_Event.message");
          CHK_(ptr);
        } else goto handle_unusual;
        continue;
      default: {
...
::PROTOBUF_NAMESPACE_ID::uint8* SSL_Referee_Game_Event::InternalSerializeWithCachedSizesToArray(
    ::PROTOBUF_NAMESPACE_ID::uint8* target, ::PROTOBUF_NAMESPACE_ID::io::EpsCopyOutputStream* stream) const {
